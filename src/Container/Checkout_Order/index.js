...
class CheckPaymentConform extends React.Component {
  constructor() {
    super();
    this.state = {
      ...
      .then((res) => {
        ...
        if (res.data.response_code == 2000) {
          ...
          const paymentCredits =
            responseData[0].credit + responseData[0].free_credit;

          // console.log('Credit List response data', responseData);
          this.setState({
            CreditsCategoryData: responseData,
            paymentCredits,
            paymentPrice: responseData[0].price,
            creditType: responseData[0]._id,
          });
  ...
  handleQuality = (item) => {
    ...
    if (this.state.myCredits < totalCredits) {
      this.setState({ Needcredits, quentity, totalCredits });
      // console.log("big");
    } else {
      this.setState({ quentity, Needcredits: 0, totalCredits });
      // console.log("small");
    }
    // console.log(
    //  totalCredits,
  ...
  handleOPtionCredit = (e) => {
    ...
    this.state.CreditsCategoryData.map((item) =>
      ...
      e.target.value == item._id
        ? (this.setState({
            paymentCredits: item.credit + item.free_credit,
  ...
  handleSubmitButton = () => {
    ...
    if (this.state.saficiantCredit) {
      ...
      if (user) {
        ...
        // console.log("pass buy ==== ",body,Api.API_URL,user.authtoken);
            ...
            <div className="container">
              <h6>
                <Link
                  ...
                  style={{ fontSize: 18, color: "#3498DB" }}
                >
                  <b>Checkout Payment Option</b>
                </Link>{" "}
                {">"} <span>Checkout</span>
              </h6>
              <div className="row">
                <div className="col-lg-12 col-sm-12" id="payment-option">
                  <h3>
                  ...
                  {!this.state.saficiantCredit ? (
                    ...
                    >
                      <b style={{ color: "red", fontSize: 25 }}>
                        You don't have sufficient credits to buy more credits
                      </b>
                    </div>
                  ) : null}
                    ...
                    <div className="row" id="plan-table">
                      <div className="col-lg-10 mx-auto" id="plan-box-on">
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6 col-md-6 col-6 text-right">
                            ...
                            <select
                              ...
                              >
                                {this.state.CreditsCategoryData &&
                                  this.state.CreditsCategoryData.map(
                                    (creditItem, creditIndex) => (
                                      <option
                                        key={creditIndex}
                                        value={creditItem._id}
                                      >
                                        {creditItem.credit +
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6 col-md-6 col-6 text-right">
                            <h4>
                            {this.state.paymentCredits + this.state.myCredits}{" "}
                              Credits
        ...
        <div>
          <Modal show={this.state.modalIsOpen} dialogClassName="modal-90w">
            ...
            <Payment_information
              ...
              credit={this.state.paymentCredits}
...
export default connect(mapStateToProps, mapPropsToState)(CheckPaymentConform);
